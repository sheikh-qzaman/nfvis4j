...
public class NfvisRequest<R>{
	...
	public NfvisRequest(NfvisRestClient client, String method, CharSequence path, Entity<?> entity, Class<R> returnType) {
		this.client = client;
		this.method = method;
	...
	public NfvisRequest<R> queryParams(Map<String, List<Object>> queryParams) {
